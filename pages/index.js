...
function TypeWriter({
  ...
  return (
    <Text as="span">
      ...
      <Text as="span" color="purple.300" opacity={showCursor ? 1 : 0}>
        |
      </Text>
    </Text>
  );
  ...
  return (
    <>
      ...
      >
        ...
        <Container maxW="6xl" pt={{ base: 20, md: 28 }} pb={{ base: 16, md: 20 }}>
          <VStack textAlign="center" spacing={7}>
            ...
            <Text color="gray.300" maxW="3xl" fontSize="xl" px={4}>
              ...
              fintech) . Have some other skills like Next.js, React, & Node.js.
            </Text>
        ...
        <Box bg="blackAlpha.400" borderY="1px solid" borderColor="whiteAlpha.200" py={5} overflow="hidden">
          <Text textAlign="center" fontSize="xs" textTransform="uppercase" letterSpacing="widest" color="gray.400" mb={4}>
          ...
          <Grid templateColumns={{ base: "1fr", md: "repeat(3, 1fr)" }} gap={6}>
            {featuredProjects.map((project, idx) => (
              <GridItem key={project.title}>
                <MotionBox
                  whileHover={{ rotateX: -4, rotateY: idx % 2 === 0 ? 5 : -5, y: -8 }}
                  ...
                  <VStack align="start" spacing={4} p={6}>
                    ...
                    <HStack spacing={2} wrap="wrap">
                      {project.tech.map((item) => (
                        <Badge key={item} borderRadius="md" colorScheme="whiteAlpha">
                          {item}
                        </Badge>
                      ))}
                    </HStack>
        ...
        <Container maxW="4xl" py={{ base: 16, md: 24 }}>
          <Text textAlign="center" color="orange.400" textTransform="uppercase" letterSpacing="widest" fontSize="sm">
          ...
          <MotionBox
            ...
            p={{ base: 6, md: 8 }}
          >
            <Text fontSize="lg" textAlign="center" color="gray.100" fontWeight="bold">
            ...
            <Text fontSize={{ base: "md", md: "lg" }} textAlign="center" color="gray.300">
              {experiences[activeExperience].detail}
            </Text>
            <HStack justify="center" mt={8} spacing={3}>
              <Flex
                ...
                fontWeight="bold"
              >
                {experiences[activeExperience].initials}
              </Flex>
              <Box>
                <Text fontWeight="bold">{experiences[activeExperience].title}</Text>
        ...
        <Box id="contact" py={{ base: 16, md: 24 }}>
          <Container maxW="4xl" textAlign="center">
            <Text color="orange.300" textTransform="uppercase" letterSpacing="widest" fontSize="sm">
              Let&apos;s Connect
            </Text>
            <Heading mt={3} mb={4}>
